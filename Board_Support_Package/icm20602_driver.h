#ifndef __ICM20602_DRIVER_H
#define __ICM20602_DRIVER_H

#include "stm32f4xx.h"


#define ICM20602_CS(X)			(X==0)? HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_RESET)): MPU_NSS_HIGH HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_SET) //MPU6500片选信号
